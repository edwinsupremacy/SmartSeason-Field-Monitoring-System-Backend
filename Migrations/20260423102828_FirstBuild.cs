        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fields_AspNetUsers_AssignedAgentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldUpdates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FieldUpdates_AspNetUsers_AgentId",
                        column: x => x.AgentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FieldUpdates_Fields_FieldId",
                        column: x => x.FieldId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fields_AssignedAgentId",
                table: "Fields",
                column: "AssignedAgentId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldUpdates_AgentId",
                table: "FieldUpdates",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldUpdates_FieldId",
                table: "FieldUpdates",
                column: "FieldId");
        }
